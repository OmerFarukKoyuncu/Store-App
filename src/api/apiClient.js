...
axios.defaults.withCredentials = true; //requestle birlikte cookide gönderilir bunu true çekersek

//Token kontorlü için requestlerde tokenda gönderiliyor.
    ...
    switch (status) {
      ...
      case 403:
        if (data.errors) {
          ...
          //throw diyerek bu hatayı fırlatıyoruz ve catch bloğunda yakalanıyor.
          throw result;
        }
        break;
      case 404:
